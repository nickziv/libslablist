...
extern int list_get_last_subslab(slablist_t *, slablist_elem_t, subslab_t *);
extern int list_get_last_slab(slablist_t *, slablist_elem_t, slab_t *);
extern int subslab_get_last_subslab(slablist_t *, slablist_elem_t, subslab_t *, int);
extern int subslab_get_last_slab(slablist_t *, slablist_elem_t, slab_t *, int);
extern int slab_get_last_elem(slablist_t *, slablist_elem_t, slab_t *, int);
